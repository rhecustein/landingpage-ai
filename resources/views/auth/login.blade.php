                ...
                <div class="nav-start-wrap">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-img d-inline-block" src="{{ asset('img/logo-light-autobot.png') }}"
                            alt="Logo Autobot Ws" height="50px" />
                    </a>
                </div>
                <!-- /Start Nav -->
                        ...
                        <li class="nav-item nav-link py-0">
                            <button class="btn btn-sm btn-outline-light"><span><span class="icon"><span
                                            class="feather-icon"><i
                                                data-feather="help-circle"></i></span></span><span>Get
                            ...
                            <div class="auth-content py-md-0 py-8">
                                <div class="row">
                                    <div class="col-xxl-9 col-xl-8 col-lg-11 text-center mx-auto">
                                        <img src="{{ asset('html/classic/dist/img/macaroni-logged-out.png') }}"
                                            class="img-fluid w-sm-40 w-50 mb-3" alt="login" />
                                        <h3 class="mb-2">Memberdayakan masa depan dengan AI</h3>
                                        <p class="w-xxl-65 w-100 mx-auto">AI dapat membantu meningkatkan efisiensi kerja
                                            dengan melakukan tugas-tugas yang membutuhkan waktu lama secara otomatis.
                                        </p>
                                        <a href="#" class="btn btn-sm btn-primary btn-uppercase mt-4">Lihat
                                            Promo</a>
                                        <p class="p-xs mt-5 text-light">All illustration are powered by <a
                                                href="https://icons8.com/ouch/" target="_blank"
                                                class="text-light"><u>Icons8</u></a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="form-check form-check-sm mb-3">
                                                    ...
                                                    <label class="form-check-label text-muted fs-7"
                                                        for="logged_in">Biarkan saya tetap login</label>
                                                </div>
                                            </div>
                                            <x-button class="btn btn-primary btn-uppercase btn-block">
                                                {{ __('Log in') }}
                                            </x-button>
                                            <p class="p-xs mt-2 text-center">Baru di Autobot WS ? <a
                                                    href="#"><u>Membuat akun baru</u></a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
