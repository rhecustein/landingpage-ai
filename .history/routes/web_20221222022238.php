...
use App\Http\Controllers\Backend\BackendController\UserController; as UserController;
/*
|--------------------------------------------------------------------------
| Web Routes
|--------------------------------------------------------------------------
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        */
        ...
        Route::group(['namespace' => 'App\Http\Controllers\Backend\BackendController\UserController', 'as' => 'client.'], function () {
            ...
            Route::get('client/overview', 'UserController@create')->name('create');
            Route::post('client/store', 'UserController@store')->name('store');
            Route::get('client/{id}/edit', 'UserController@edit')->name('edit');
            Route::patch('client/{id}/update', 'UserController@update')->name('update');
            Route::delete('client/{id}/destroy', 'UserController@destroy')->name('destroy');
        });
        // overview
