    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        */
        ...
        Route::group(['namespace' => 'App\Http\Controllers\Frontend', 'as' => 'client.'], function () {
            Route::get('client', 'UserController@index')->name('overview');
            Route::get('overview', 'UserController@overview')->name('overview');
            Route::get('chatbot', 'UserController@chatbot')->name('chatbot');
            Route::get('client/voice', 'UserController@voice')->name('voice');
            Route::patch('client/usage', 'UserController@usage')->name('usage');
            Route::delete('client/device', 'UserController@device')->name('device');
            Route::get('client/tagihan', 'UserController@tagihan')->name('tagihan');
            Route::get('client/apikey', 'UserController@apikey')->name('apikey');
            Route::get('client/offers', 'UserController@offers')->name('offers');
            Route::get('client/referral', 'UserController@referral')->name('referral');
            Route::get('client/agent', 'UserController@agent')->name('agent');
            Route::get('client/paymentmethod', 'UserController@paymentmethod')->name('paymentmethod');
            Route::get('client/subscription', 'UserController@subscription')->name('subscription');
            Route::get('client/settings', 'UserController@settings')->name('settings');
            Route::get('client/raiseticket', 'UserController@raiseticket')->name('raiseticket');
            Route::get('client/ticket', 'UserController@ticket')->name('ticket');
            Route::get('client/faq', 'UserController@faq')->name('faq');
            Route::get('client/faq/{id}', 'UserController@faq')->name('faq');
            Route::get('client/faq/{id}/edit', 'UserController@faq')->name('faq');
        });
        //profile
