<div data-simplebar class="nicescroll-bar">
    <div class="menu-content-wrap">
        ...
        <div class="menu-group">
            ...
            <ul class="navbar-nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('frontend.$module_name.overview.chatbot') }}">
                        <span class="nav-icon-wrap">
                            <span class="svg-icon">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span class="nav-link-text">Voice Maker</span>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span class="nav-link-text">Image Maker</span>
                        <span class="badge badge-sm badge-soft-pink ms-auto">On Dev</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        ...
                        <span class="nav-link-text">Letter Maker</span>
                        <span class="badge badge-sm badge-soft-pink ms-auto">On Dev</span>
                    </a>
                </li>
            </ul>
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link" href="usage">
                        <span class="nav-icon-wrap">
                            <span class="svg-icon">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="icon icon-tabler icon-tabler-layout-kanban" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        ...
                        <span class="nav-link-text">Penggunaan</span>
                    </a>
                </li> -->
                <li class="nav-item">
