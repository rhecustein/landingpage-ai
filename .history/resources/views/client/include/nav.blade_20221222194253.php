                            ...
                            <!-- <div data-simplebar class="dropdown-body  p-2">
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                <div class="notifications-text">Morgan Freeman accepted your invitation
                                                    to join the team</div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                <div class="notifications-text">New message received from Alan Rickman
                                                </div>
                                                <div class="notifications-info">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                <div class="notifications-text">You have a follow up with Jampack Head
                                                    on Friday, Dec 19 at 9:30 am</div>
                                                <div class="notifications-info">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                <div class="notifications-text">Application of Sarah Williams is waiting
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                <div class="notifications-text">Winston Churchil shared a document with
                                                    you</div>
                                                <div class="notifications-info">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <div>
                                                <div class="notifications-text">Last 2 days left for the project to be
                                                    completed</div>
                                                <div class="notifications-info">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <div class="p-2">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="dropdown">
                                            <a href="#" class="d-block dropdown-toggle link-dark fw-medium">Hencework</a>
                                        </div>
                            ...
                            <a class="dropdown-item" href="#"><span class="me-2">Menjadi Agent</span><span
                                    class="badge badge-sm badge-soft-pink">1</span></a>
                                    <a class="dropdown-item" href="#"><span class="me-2">Referral</span><span
                                    class="badge badge-sm badge-soft-pink">1</span></a>
                            <div class="dropdown-divider"></div>
