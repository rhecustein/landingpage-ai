			...
			<div class="menu-header">
				<span>
					<a class="navbar-brand" href="index.html">
						<img class="brand-img img-fluid" src="{{ asset ('img/logo-light-autobot.png') }}" alt="logo autobot" height="30px"/>
						<img class="brand-img img-fluid" src="{{ asset ('img/logo-light-autobot.png') }}" alt="logo autobot" />
					</a>
