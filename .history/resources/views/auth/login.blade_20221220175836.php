							...
							<div class="auth-content py-md-0 py-8">
								<div class="row">
									<div class="col-xxl-9 col-xl-8 col-lg-11 text-center mx-auto">
										...
										<p class="w-xxl-65 w-100 mx-auto">AI dapat membantu meningkatkan efisiensi kerja dengan melakukan tugas-tugas yang membutuhkan waktu lama secara otomatis, sehingga mengurangi waktu yang diperlukan untuk menyelesaikan proyek</p>
