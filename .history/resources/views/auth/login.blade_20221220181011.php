...
<body>
			...
			<div class="container-xxl">
				...
				<div class="nav-start-wrap">
					<a class="navbar-brand" href="index.html">
						<img class="brand-img d-inline-block" src="{{ asset ('img/logo-light-autobot.png') }}" alt="Logo Autobot Ws" height="50px" />
					</a>
				</div>
				<!-- /Start Nav -->
							...
							<div class="auth-content py-md-0 py-8">
								<div class="row">
									<div class="col-xxl-9 col-xl-8 col-lg-11 text-center mx-auto">
										<img src="{{ asset ('html/classic/dist/img/macaroni-logged-out.png') }}"  class="img-fluid w-sm-40 w-50 mb-3" alt="login"/>
										<h3 class="mb-2">Memberdayakan masa depan dengan AI</h3>
										<p class="w-xxl-65 w-100 mx-auto">AI dapat membantu meningkatkan efisiensi kerja dengan melakukan tugas-tugas yang membutuhkan waktu lama secara otomatis.</p>
										<a href="#" class="btn btn-sm btn-primary btn-uppercase mt-4">Lihat Promo</a>
										...
										<div class="col-lg-10 mx-auto">
											...
											<div class="row gx-3">
												<div class="form-group col-lg-12">
													...
													<input class="form-control" placeholder="Enter username or email ID" type="email" name="email" :value="old('email')" required autofocus>
												</div>
												<div class="form-group col-lg-12">
													<div class="form-label-group">
														<label>Password</label>
														<a href="#" class="fs-7 fw-medium">Lupa Kata Sandi ?</a>
													</div>
											...
											<div class="d-flex justify-content-center">
												<div class="form-check form-check-sm mb-3">
													...
													<label class="form-check-label text-muted fs-7" for="logged_in">Biarkan saya tetap login</label>
												</div>
											</div>
	...
	<!-- jQuery -->
    <script src="vendors/jquery/{{ asset ('html/classic/dist/jquery.min.js') }}"></script>

    <!-- Bootstrap Core JS -->
   	<script src="vendors/bootstrap/{{ asset ('html/classic/dist/js/bootstrap.bundle.min.js') }}"></script>
	...
	<!-- Simplebar JS -->
	<script src="vendors/simplebar/{{ asset ('html/classic/dist/simplebar.min.js') }}"></script>
