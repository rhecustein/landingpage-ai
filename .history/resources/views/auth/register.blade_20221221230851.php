										...
										<div class="col-lg-10 mx-auto">
											...
											<div class="row gx-3">
												<div class="form-group col-lg-6">
													...
													<input class="form-control" placeholder="Enter your name" value="" type="text" name="first_name" :value="old('first_name')" required autofocus>
												</div>
												<div class="form-group col-lg-6">
													<label class="form-label">Username</label>
													<input class="form-control" placeholder="Enter username" value="" type="text" name="last_name" :value="old('last_name')" required autofocus >
												</div>
