...
<head>
	...
	<!-- CSS -->
    <link href="{{ asset('html/classci/dist/css/style.css') }}" rel="stylesheet" type="text/css">
</head>
<body>
   	<!-- Wrapper -->
	...
	<!-- jQuery -->
    <script src="{{ asset('html/classci/vendors/jquery/dist/jquery.min.js') }]"></script>

    <!-- Bootstrap Core JS -->
   	<script src="{{ asset('html/classci/vendors/bootstrap/dist/js/bootstrap.bundle.min.js') }]"></script>

    <!-- FeatherIcons JS -->
    <script src="{{ asset('html/classci/dist/js/feather.min.js') }]"></script>

    <!-- Fancy Dropdown JS -->
    <script src="{{ asset('html/classci/dist/js/dropdown-bootstrap-extended.js') }]"></script>

	<!-- Simplebar JS -->
	<script src="{{ asset('html/classci/vendors/simplebar/dist/simplebar.min.js') }]"></script>
	
	<!-- Init JS -->
	<script src="{{ asset('html/classci/dist/js/init.js') }]"></script>
</body>
</html>