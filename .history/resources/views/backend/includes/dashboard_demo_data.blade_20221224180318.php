    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4">
            <div class="card-body">
                ...
                </div><small class="text-medium-emphasis">Total User Terverifikasi</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4">
            <div class="card-body">
                ...
                </div><small class="text-medium-emphasis">Respon Keseluruhan</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4">
            <div class="card-body">
                ...
                <div>User Premium</div>
                <div class="progress progress-thin my-2">
                    <div class="progress-bar bg-warning" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div><small class="text-medium-emphasis">Total User Premium</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4">
            <div class="card-body">
                ...
                </div><small class="text-medium-emphasis">Total Pendapatan Bulan ini</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-primary">
            <div class="card-body">
                ...
                </div><small class="text-medium-emphasis-inverse">Total Language models Respon</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-danger">
            <div class="card-body">
                ...
                <div class="progress progress-white progress-thin my-2">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div><small class="text-medium-emphasis-inverse">Respon Buat S</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
