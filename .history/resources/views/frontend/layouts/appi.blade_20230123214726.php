...
<head>
    ...
    <title>AI Autobot Ws</title>
    <link rel="stylesheet" href="{{ asset('cybox/cybox/app/bootstrap/css/bootstrap.css') }}">
    <link rel="stylesheet" href="{{ asset('cybox/cybox/app/swiper/swiper-bundle.min.css') }}">
    <link rel="stylesheet" href="{{ asset('cybox/cybox/app/dist/app.css') }}">
    <link rel="stylesheet" href="{{ asset('cybox/cybox/assets/font/font-awesome.css') }}">
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css') }}" rel="stylesheet">
    <!-- Favicon and Touch Icons  -->
    <link rel="shortcut icon" href="{{ asset('cybox/cybox/assets/images/favicon.png') }}">
    <link rel="apple-touch-icon-precomposed" href="{{ asset('cybox/cybox/assets/images/favicon.png') }}">
</head>
        ...
        <div class="container">
            <div id="site-header-inner">
                <div class="header__logo">
                    <a href="index.html"><img src="{{ asset('cybox/cybox/assets/images/logo/logo.png') }}" alt=""></a>
                </div>
...
@yield('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body center">
                    <div class="box-wallet-inner">
                        <div class="sc-box">
                            <div class="img">
                                <img src="{{ asset('img/Whatsapp-stiker-removebg-preview.png') }}" alt="Image">
                            </div>
                            <h6 class="heading"><a href="login.html">Buat Stiker Whatsapp</a> </h6>
                            <p class="content">Membuat Stiker Whatsapp mudah dan cepat hanya dari Foto.</p>
                        </div>
                        <div class="sc-box">
                            <div class="img">
                                <img src="{{ asset('img/Youtube-downloader-removebg-preview.png') }}" alt="Image">
                            </div>
                            <h6 class="heading"><a href="login.html">Youtube Downloader</a></h6>
                            <p class="content">Download video youtube dengan format mp3/mp4 dengan mudah hanya butuh link youtube.</p>
                        </div>
                        <div class="sc-box">
                            <div class="img">
                                <img src="{{ asset('img/Whatsapp-stiker-removebg-preview.png') }}" alt="Image">
    ...
    <a id="scroll-top"></a>
    <script src="{{ asset('cybox/cybox/app/js/jquery.min.js') }}"></script>
    <script src="{{ asset('cybox/cybox/app/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('cybox/cybox/app/js/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('cybox/cybox/app/js/swiper.js') }}"></script>
    <script src="{{ asset('cybox/cybox/app/js/app.js') }}"></script>
    <script src="{{ asset('cybox/cybox/app/js/jquery.easing.js') }}"></script>
    <script src="https://unpkg.com/aos@2.3.1/dist/aos.js"></script>
     <script src="{{ asset('cybox/cybox/app/js/parallax.js') }}"></script>
     <script src="{{ asset('cybox/cybox/app/js/jquery.magnific-popup.min.js') }}"></script>
</body>
</html>