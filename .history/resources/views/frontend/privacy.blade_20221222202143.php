...
<div class="section">
    <div class="container text-center text-slate-200">
        ...
        <p class="mx-3">Kami di autoboot.co.id menghargai privasi Anda dan menghormati hak-hak privasi Anda. Kami berkomitmen untuk melindungi informasi pribadi yang Anda berikan kepada kami saat menggunakan layanan kami.</p>
    </div>
</div>
