...
<div class="section">
    <div class="container text-center text-slate-200">
        ...
        <p class="container mx-5 mt-4">Dengan mendaftarkan nomor telepon Anda di website kami, <br>Anda memberikan persetujuan kepada kami untuk menyimpan <br>dan menggunakan informasi tersebut hanya untuk tujuan menjaga agar tetap kondusif dalam penggunaan Chatbot autobot secara aman dan nyaman. </p>
    </div>
</div>
