...
<section class="bg-stone-900 mb-20">
    <div class="container mx-auto flex px-1 sm:px-20 py-20 md:flex-row flex-col items-center">
        ...
        <div class="lg:flex-grow md:w-1/2 px-4 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p class="mb-8 sm:text-4xl text-sm text-neutral-50">
            Chat AI adalah sebuah teknologi yang menggunakan kecerdasan buatan untuk memungkinkan komunikasi secara langsung melalui chat atau pesan teks. Manfaat utamanya adalah memudahkan proses komunikasi, terutama ketika menghadapi pertanyaan yang sama berulang-ulang, dan membantu menyederhanakan proses pencarian informasi. Chat AI juga dapat membantu meningkatkan efisiensi dan produktivitas, karena dapat membantu menangani tugas-tugas yang rutin dan memberikan jawaban cepat kepada pelanggan atau pengguna.
            </p>
            <div class="flex justify-center">
                <a href="" class="inline-flex text-white bg-green-700 border-0 py-2 px-6 focus:outline-none hover:bg-gray-800 rounded text-lg">
