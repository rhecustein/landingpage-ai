            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tf-title st2 m-b60" data-aos="fade-up" data-aos-duration="800">
                        <p class="h8 sub-title">Sponsor</p>
                        <h4 class="title m-b17">Menjadi SPONSORSHIP</h4>
                        <p class="p-r60">Kamu bisa mendapatkan source code AIDEN ini dengan cara menjadi SPONSORSHIP, dan mendapatkan pembaruannya selama 1 tahun. </p>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
                    <div class="box-text st2 corner-box active">
                        ...
                        <div class="h7">Registerasi</div>
                        <p>Mendaftar untuk menjadi sponsorship dengan kami. 
                            Isi biodata dan lakukan memilihan paket layanan pada yang tersedia, saat ini Paket Whatsapp bot AIDEN atau Paket Lengkap + Dashboard.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="800">
                    <div class="box-text st2 corner-box">
                        ...
                        <div class="h7">Melakukan Pembayaran</div>
                        <p>Harga terjangkau untuk menjadi sponsorship untuk mendapatkan source Code ini anda dapat melakukan pemesanan di <a href="https://wa.me/6285864541619">VIA WHATSAPP</a> atau bisa melakukan pembelian di tokopedia di <a href="https://www.tokopedia.com/kodekita/whatsapp-bot-open-ai-aiden">disini</a>.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="800">
                    <div class="box-text st2 corner-box">
                        <div class="number">03</div>
                        <div class="h7">Bantuan Teknis Developer</div>
                        <p>Setelah Menjadi sponsorship, Kami Membantu anda untuk melakukan setup system pada hosting, maupun local komputer, serta melakukan pelatihan untuk menjalankan oprasional Bot AIDEN.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400" data-aos-duration="800">
                    <div class="box-text st2 mobie-mb-0 corner-box">
                        ...
                        <div class="h7">UPDATE</div>
                        <p>Update AIDEN akan terus ada, selama perkembangan Teknologi yang memungkinan untuk di tambahkan pada system AIDEN, atau pun REQUEST dari pengguna untuk menyediakan Fitur yang berguna.</p>
                    </div>
                </div>
            </div>
        </div>
